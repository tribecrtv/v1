                    ...
                    <a href="https://live.thetribeabuja.com/" target="blank">
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="hidden md:block h-4 w-4 transform rotate-90 text-red-800" viewBox="0 0 20 20"
                                fill="currentColor">
    ...
    <div class="place-self-center md:w-2/3 lg:w-2/3">
        <div class="grid md:rounded-2xl bg-gray-100">
            <div class="p-10 space-y-3">
                ...
                <div class="text-3xl tracking-tight">Join the movement!<span class="animate-ping">&#9889;</span></div>
        ...
        <div class="grid grid-cols-2 md:rounded-2xl bg-gray-100">
            ...
            <div class="p-10 space-y-3">
                ...
                <div class="tracking-tight flex items-center space-x-4">
                    <a href="https://itunes.apple.com/us/podcast/the-tribe-abuja/id1447100125?mt=2&uo=4" target="blank">
                    ...
                    <a href="https://open.spotify.com/show/5gF11b5BCovX5S9RpE1BOr" target="blank">
                        <svg class="h-6 text-green-500" fill="currentColor" viewBox="-33.4974 -55.829 290.3108 334.974">
                            <path
